...
fun measureStortTime(algorith: (IntArray) -> Unit, arr: IntArray): Long {
...
fun main(args: Array<String>) {
    ...
    val bubbleSmall = measureStortTime(::bubbleSort, smallList)
    val insertionSmall = measureStortTime(::insertionSort, smallList)
    val selectionSmall = measureStortTime(::selectionSort, smallList)
